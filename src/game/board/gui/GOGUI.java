...
public interface GOGUI {
     ...
     * @param x the x coordinate of the stone/area indicator to remove, 
     * ranges from 0 to boardSize - 1.
     * @param y the y coordinate of the stone/area indicator to remove, 
     * ranges from 0 to boardSize - 1.
     * @throws InvalidCoordinateException when x or y coordinate fall outside of the board.
     */
